...
Intent Capture is a lightweight native macOS utility for quick screenshot, OCR, and color-picking workflows. It lives in the menu bar, supports global keyboard shortcuts, and can use the mouse middle button as a fast trigger.

Intent Capture 是一个轻量级 macOS 原生效率工具，用于快速截图、OCR 文字识别和取色。它常驻菜单栏，支持全局快捷键，也可以用鼠标中键快速触发。
...
- Menu bar app with a compact action panel
